...
CREATE TABLE `user` (
  ...
  `openid` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '微信用户唯一标识',
...
INSERT INTO `user` VALUES (1,'oYrlP14OsDG2fWjEpJ2V-ZOUmqhY',NULL,NULL,NULL,NULL,NULL,'2026-08-25 22:02:06');
