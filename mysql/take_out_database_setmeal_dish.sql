...
CREATE TABLE `setmeal_dish` (
  ...
  `name` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '菜品名称',
  `price` decimal(10,2) DEFAULT NULL COMMENT '菜品单价',
  `copies` int DEFAULT NULL COMMENT '菜品份数',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='套餐菜品关系表';
...
INSERT INTO `setmeal_dish` VALUES (10,6,8,'555',55555.00,3),(11,6,2,'test',10.00,2),(12,6,7,'666',20.00,2),(19,9,1,'大酱炒笨蛋',9.00,5);
